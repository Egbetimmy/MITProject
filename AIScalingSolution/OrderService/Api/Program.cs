...
builder.Services.AddCommonInfrastructure(builder.Configuration, "OrderService");
builder.Services.AddOrderInfrastructure(builder.Configuration);
builder.Services.AddControllers();
builder.Services.AddEndpointsApiExplorer();
builder.Services.AddSwaggerGen(c => c.SwaggerDoc("v1", new() { Title = "Order Service API", Version = "v1" }));
